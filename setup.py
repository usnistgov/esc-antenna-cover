...
def read_version():
    ...
    version_path = os.path.sep.join((here, "circlecover", "version.py"))
    v_globals = {}
    v_locals = {}
...
setup(
  ...
  description = ("Minimum area circle cover approximation algorithm"
    " for ESC sensor placement"),
  ...
  install_requires = ['numpy', 'descartes'] #, 'png', 'freetype2.0'
)
